  ...
  const quickLinks = [
    {
      ...
      description: "Dapatkan nomor antrian untuk layanan yang Anda butuhkan.",
      href: "/queue-ticket",
    ...
    },
    {
      ...
      description: "Lihat display antrian saat ini.",
      href: "/queue-display",
      icon: "list",
      color: "bg-purple-500",
    },
    {
      ...
      description: "Periksa status antrian Anda secara real-time.",
      href: "/queue-status",
      icon: "search",
      color: "bg-green-500",
    },
    ...
    <div className="space-y-6">
      <Card>
        ...
        <p className="text-lg text-gray-600">
          Sistem ini membantu Anda mengelola antrian dengan efisien dan
          memberikan pengalaman yang lebih baik bagi pelanggan Anda.
        </p>
      </Card>
      <div>
